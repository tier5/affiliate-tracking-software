    ...
    <div class="portlet-body form">
        <form class="form-horizontal" role="form" id="agencyform" method="post" autocomplete="off">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?php echo $subscriptionPricingPlans; ?>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?php echo $form->render('email', array('class' => 'form-control', 'placeholder' => 'Email', 'type' => 'name')); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="phone" class="col-md-4 control-label">Phone</label>
                <div class="col-md-8">
                    <?php echo $form->render('phone', array('class' => 'form-control', 'placeholder' => 'Phone', 'type' => 'name')); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="address" class="col-md-4 control-label">Address</label>
                <div class="col-md-8">
                    <?php echo $form->render('address', array('class' => 'form-control', 'placeholder' => 'Address', 'type' => 'name')); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="locality" class="col-md-4 control-label">City</label>
                <div class="col-md-8">
                    <?php echo $form->render('locality', array('class' => 'form-control', 'placeholder' => 'City', 'type' => 'name')); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="state_province" class="col-md-4 control-label">State/Province</label>
                <div class="col-md-8">
                    <?php echo $form->render('state_province', array('class' => 'form-control', 'placeholder' => 'State/Province', 'type' => 'name')); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="postal_code" class="col-md-4 control-label">Postal Code</label>
                <div class="col-md-8">
                    <?php echo $form->render('postal_code', array('class' => 'form-control', 'placeholder' => 'Postal Code', 'type' => 'name')); ?>
                </div>
            </div>
            <?php if ($agency_id>0) { ?>
