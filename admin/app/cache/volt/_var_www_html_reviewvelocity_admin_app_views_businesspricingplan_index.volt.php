                        ...
                        <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                            <div class="table-scrollable">
                                <table class="table table-striped table-bordered table-hover dt-responsive dataTable no-footer dtr-inline collapsed" width="100%" id="sample_1" role="grid" aria-describedby="sample_1_info" style="width: 100%;">
                                    ...
                                    <tbody>
                                    <?php foreach ($pricingProfiles as $pricingProfile) { ?>
                                        <tr id="<?php echo $pricingProfile->id; ?>" role="row">
                                            <td><?php echo $pricingProfile->name; ?></td>
                                            <?php if ($pricingProfile->enable_trial_account == true) { ?>
                                                <td>Trial</td>
                                            <?php } else { ?>
                                                <td>Paid</td>
                                            <?php } ?>
                                            <?php if ($pricingProfile->enabled == true) { ?>
                                            ...
                                            <td><a href="/businessPricingPlan/editExistingPricingPlan/<?php echo $pricingProfile->id; ?>" class="btn default btn-lg apple-backgound subscription-btn"><i class="fa fa-edit"></i></a></td>
