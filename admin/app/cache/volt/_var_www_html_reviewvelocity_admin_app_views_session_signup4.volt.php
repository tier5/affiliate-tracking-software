...
<form class="register-form4" action="<?=((strpos($_SERVER['REQUEST_URI'],'location')>0)?'/location/create3/'.$location_id:'/session/signup4/'.(isset($subscription->subscription_id)?$subscription->subscription_id:'').(isset($_GET['code'])?'?code='.$_GET['code']:''))?>" method="post" style="display: block;">
  ...
  ?>
    ...
    <?php $v169580046576182279771iterated = false; ?><?php $v169580046576182279771iterator = $users; $v169580046576182279771incr = 0; $v169580046576182279771loop = new stdClass(); $v169580046576182279771loop->length = count($v169580046576182279771iterator); $v169580046576182279771loop->index = 1; $v169580046576182279771loop->index0 = 1; $v169580046576182279771loop->revindex = $v169580046576182279771loop->length; $v169580046576182279771loop->revindex0 = $v169580046576182279771loop->length - 1; ?><?php foreach ($v169580046576182279771iterator as $user) { ?><?php $v169580046576182279771loop->first = ($v169580046576182279771incr == 0); $v169580046576182279771loop->index = $v169580046576182279771incr + 1; $v169580046576182279771loop->index0 = $v169580046576182279771incr; $v169580046576182279771loop->revindex = $v169580046576182279771loop->length - $v169580046576182279771incr; $v169580046576182279771loop->revindex0 = $v169580046576182279771loop->length - ($v169580046576182279771incr + 1); $v169580046576182279771loop->last = ($v169580046576182279771incr == ($v169580046576182279771loop->length - 1)); ?><?php $v169580046576182279771iterated = true; ?>
      <?php if ($v169580046576182279771loop->first) { ?>
      ...
      <?php if ($v169580046576182279771loop->last) { ?>
        </tbody>
        </table>
      <?php } ?>
    <?php $v169580046576182279771incr++; } if (!$v169580046576182279771iterated) { ?>
