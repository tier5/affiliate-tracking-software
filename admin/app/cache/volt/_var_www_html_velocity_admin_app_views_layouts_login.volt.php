...
<body class=" login">
    ...
    <?php if(!(strpos($_SERVER['REQUEST_URI'],'thankyou')>0 || strpos($_SERVER['REQUEST_URI'],'signup')>0) || 
      ...
      <!-- BEGIN LOGO -->
      <div class="logo">
          <a href="/admin/"><img src="<?=(isset($logo_setting) && $logo_setting != ''?$logo_setting:'/admin/img/logo-gray.gif')?>" alt="" /></a>
      </div>
      <!-- END LOGO -->
    <?php } ?>
    ...
    <?php if((strpos($_SERVER['REQUEST_URI'],'thankyou')>0 || strpos($_SERVER['REQUEST_URI'],'signup')>0) && 
      ...
      <!-- END LOGO -->
    <?php } ?>
    <div class="copyright"> &copy; <?php echo date('Y'); ?> All Rights Reserved. Review Velocity. <a href="/admin/session/privacy">Privacy</a> | <a href="/admin/session/terms">Terms</a></div>
    <!--[if lt IE 9]>
