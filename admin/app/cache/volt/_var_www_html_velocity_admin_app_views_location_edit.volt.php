...
<ul class="pager">
    <li class="previous pull-left">
      <?php echo $this->tag->linkTo(array('/admin/location', '&larr; Go Back')); ?>
    </li>
</ul>
...
<div class="portlet light bordered">
  ...
  <div class="portlet-body form">
    ...
    <form id="hiddenForm" class="form-horizontal" role="form" method="post" autocomplete="off">
      ...
      <?php echo $form->render('locality'); ?>
      <?php echo $form->render('state_province'); ?>
      <?php echo $form->render('postal_code'); ?>
      <?php echo $form->render('country'); ?>
      <?php echo $form->render('yelp_id'); ?>
      <?php echo $form->render('facebook_page_id'); ?>
      <?php echo $form->render('google_place_id'); ?>
      <?php echo $form->render('latitude'); ?>
      <?php echo $form->render('longitude'); ?>
      <?php echo $form->render('google_api_id'); ?>
      <div class="form-group">
