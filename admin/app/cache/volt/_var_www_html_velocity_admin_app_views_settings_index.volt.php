  ...
  <div class="tab-content">
      ...
      <div class="tab-pane fade active in" id="tab_general">
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <?php echo $agencyform->render('name', array('class' => 'form-control', 'placeholder' => 'Name', 'type' => 'name')); ?>
          </div>
        </div>
        <div class="form-group">
          <label for="email" class="col-md-4 control-label">Email</label>
          <div class="col-md-8">
            <?php echo $agencyform->render('email', array('class' => 'form-control', 'placeholder' => 'Email', 'type' => 'name')); ?>
          </div>
        </div>
        <div class="form-group">
          <label for="phone" class="col-md-4 control-label">Phone</label>
          <div class="col-md-8">
            <?php echo $agencyform->render('phone', array('class' => 'form-control', 'placeholder' => 'Phone', 'type' => 'name')); ?>
          </div>
        </div>
        <div class="form-group">
          <label for="address" class="col-md-4 control-label">Address</label>
          <div class="col-md-8">
            <?php echo $agencyform->render('address', array('class' => 'form-control', 'placeholder' => 'Address', 'type' => 'name')); ?>
          </div>
        </div>
        <div class="form-group">
          <label for="locality" class="col-md-4 control-label">City</label>
          <div class="col-md-8">
            <?php echo $agencyform->render('locality', array('class' => 'form-control', 'placeholder' => 'City', 'type' => 'name')); ?>
          </div>
        </div>
        <div class="form-group">
          <label for="state_province" class="col-md-4 control-label">State/Province</label>
          <div class="col-md-8">
            <?php echo $agencyform->render('state_province', array('class' => 'form-control', 'placeholder' => 'State/Province', 'type' => 'name')); ?>
          </div>
        </div>
        <div class="form-group">
          <label for="postal_code" class="col-md-4 control-label">Postal Code</label>
          <div class="col-md-8">
            <?php echo $agencyform->render('postal_code', array('class' => 'form-control', 'placeholder' => 'Postal Code', 'type' => 'name')); ?>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <?php echo $form->render('lifetime_value_customer', array('class' => 'form-control', 'placeholder' => 'Lifetime Value of the Customer', 'type' => 'name')); ?>
          </div>
        </div>
      ...
      <div class="tab-pane fade" id="tab_review_invite">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('rating_threshold_star', array('class' => 'form-control', 'placeholder' => 'Rating Threshold (Star Rating)')); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('rating_threshold_nps', array('class' => 'form-control', 'placeholder' => 'Rating Threshold (NPS Rating)')); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('review_goal', array('class' => 'form-control', 'placeholder' => 'Review Goal')); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
      ...
      <div class="tab-pane fade in" id="tab_sms_message">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('message_tries', array('class' => 'form-control', 'placeholder' => 'Message Tries')); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('message_frequency', array('class' => 'form-control', 'placeholder' => 'Message Frequency')); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
      ...
      <div class="tab-pane fade" id="tab_white_label">
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('custom_domain', array('class' => 'form-control', 'placeholder' => 'Custom Domain')); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
      ...
      <div class="tab-pane fade" id="tab_twilio">          
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('twilio_api_key', array('class' => 'form-control', 'placeholder' => 'Twilio SID')); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('twilio_auth_token', array('class' => 'form-control', 'placeholder' => 'Twilio Auth Token')); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('twilio_auth_messaging_sid', array('class' => 'form-control', 'placeholder' => 'Twilio Messaging Service SID')); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('twilio_from_phone', array('class' => 'form-control', 'placeholder' => 'Twilio Phone Number')); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
      ...
      <div class="tab-pane fade" id="tab_stripe">          
        <div class="form-group">
          <!--<div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('stripe_account_id', array('class' => 'form-control', 'placeholder' => 'Stripe Account ID')); ?>
            </div>
          </div>-->
          <div class="row">
            <div class="col-md-12">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('stripe_account_secret', array('class' => 'form-control', 'placeholder' => 'Stripe Secret Key')); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-8">
              <?php echo $form->render('stripe_publishable_keys', array('class' => 'form-control', 'placeholder' => 'Stripe Publishable Key')); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
    ...
    <div class="form-group">
      ...
      <div class="col-md-offset-4 col-md-8">
        <?php echo $this->tag->submitButton(array('Save', 'class' => 'btn btn-big btn-success btnLink')); ?>
      </div>
    </div>
    <?php echo $form->render('agency_id'); ?>
  </form>
  </div>
</div>
