...
//echo '<pre>reviews:'.print_r($google_reviews['reviews'],true).'</pre>';
        ...
        public function importFacebook($Obj, $location, &$foundagency) {
            ...
            if (isset($Obj->access_token) && $Obj->access_token != '') {
                ...
                require_once __DIR__ . "/Facebook/Authentication/AccessToken.php";
                require_once __DIR__ . "/Facebook/Authentication/OAuth2Client.php";
                require_once __DIR__ . "/Facebook/Helpers/FacebookRedirectLoginHelper.php";
                require_once __DIR__ . "/Facebook/PersistentData/PersistentDataInterface.php";
                require_once __DIR__ . "/Facebook/PersistentData/FacebookSessionPersistentDataHandler.php";
                require_once __DIR__ . "/Facebook/Url/UrlDetectionInterface.php";
                require_once __DIR__ . "/Facebook/Url/FacebookUrlDetectionHandler.php";
                require_once __DIR__ . "/Facebook/Url/FacebookUrlManipulator.php";
                require_once __DIR__ . "/Facebook/PseudoRandomString/PseudoRandomStringGeneratorTrait.php";
                require_once __DIR__ . "/Facebook/PseudoRandomString/PseudoRandomStringGeneratorInterface.php";
                require_once __DIR__ . "/Facebook/PseudoRandomString/OpenSslPseudoRandomStringGenerator.php";
                require_once __DIR__ . "/Facebook/HttpClients/FacebookHttpClientInterface.php";
                require_once __DIR__ . "/Facebook/HttpClients/FacebookCurl.php";
                require_once __DIR__ . "/Facebook/HttpClients/FacebookCurlHttpClient.php";
                require_once __DIR__ . "/Facebook/Http/RequestBodyInterface.php";
                require_once __DIR__ . "/Facebook/Http/RequestBodyUrlEncoded.php";
                require_once __DIR__ . "/Facebook/Http/GraphRawResponse.php";
                require_once __DIR__ . "/Facebook/Exceptions/FacebookSDKException.php";
                require_once __DIR__ . "/Facebook/Exceptions/FacebookAuthorizationException.php";
                require_once __DIR__ . "/Facebook/Exceptions/FacebookAuthenticationException.php";
                require_once __DIR__ . "/Facebook/Exceptions/FacebookResponseException.php";
