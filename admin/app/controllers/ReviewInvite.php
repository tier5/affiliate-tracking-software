...
//echo '<pre>$_POST:'.print_r($_POST,true).'</pre>';
    ...
    if ($location_list != '' && ($negative == 1 || $positive == 1)) {
      ...
      $sql = "SELECT l.name AS location_name, ri.*
              ...
              WHERE l.agency_id = 1 AND ri.recommend IS NOT NULL AND ri.date_viewed IS NOT NULL
                ...
                AND ri.review_invite_id IN (SELECT MAX(ri2.review_invite_id)
		                                        ...
		                                        WHERE l2.agency_id = 1 AND ri2.recommend IS NOT NULL AND ri2.date_viewed IS NOT NULL
