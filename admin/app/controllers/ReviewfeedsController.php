<?php
    ...
    class ReviewfeedsController extends ControllerBase
    {
        ...
        public function googleAction(){
            ...
            include_once "/var/www/velocity/admin/app/library/Google/mybusiness/Mybusiness.php";


            define('APPLICATION_NAME', 'User Query - Google My Business API');

            define('CREDENTIALS_PATH', '/var/www/velocity/admin/app/models/googlesecrets.json');

            define('CLIENT_SECRET_PATH', '/var/www/velocity/admin/app/models/client_secrets.json');
