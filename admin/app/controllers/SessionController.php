...
class SessionController extends ControllerBase {
    ...
    public function inviteAction($short_code = null) {
        $this->view->short_code = $short_code;
            ...
            //ode_generate
           echo $_COOKIE['code_generate1'];exit;
    ...
    public function signupAction($subscriptionToken = '0') {
       ...
       // echo $this->request->getQuery("code");exit;
        ...
        else if($this->request->getQuery("code"))
        {
           ...
           $this->cookies->set("code_generate_tt",$code, $expire,'/','jonvaughn.reviewvelocity.net',1);
           ...
           // echo $objAgency->parent_id;exit;
            if($objAgency->parent_id==0) {
                 setcookie("code_generate1",$code, $expire,'/','jonvaughn.reviewvelocity.net',1);
