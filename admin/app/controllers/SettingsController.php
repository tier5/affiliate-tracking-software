                ...
                if (!$formvalid || !$agencyformvalid) {
                  ...
                  // echo 'k';exit;
                   ...
                   // dd($entity);
                    ...
                    {
                         $this->db->query(
                            "UPDATE `agency` SET `welcome_email`='".$this->request->getPost('welcome_email')."' ,  `viral_email`='".$this->request->getPost('viral_mail')."' ,`welcome_email_employee` ='".$this->request->getPost('welcome_email_employee')."' WHERE `agency_id`=".$Agency_id);
                    }
