...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-red-user">
            ...
            <span class="caption-subject bold uppercase"> <?=($agency_id>0?'Edit':'Create')?> <?=$CreateType; ?> </span>
        </div>
    </div>
    <div class="portlet-body form">
        <form class="form-horizontal validated" role="form" id="agencyform" method="post" autocomplete="off">
            <div class="form-group">
                <label for="subscription_pricing_plan_id" class="col-md-4 control-label"><?=$CreateType; ?> Subscription Pricing Plan</label>
                <div class="col-md-8">
                    {{ subscriptionPricingPlans }}
                </div>
            </div>
            <div class="form-group">
                <label for="name" class="col-md-4 control-label"><?=$CreateType; ?> Name</label>
                <div class="col-md-8">
                    {{ form.render("name", ["class": 'form-control', 'placeholder': 'Name', 'type': 'name','required':'']) }}
                </div>
            </div>
            <div class="form-group">
                <label for="email" class="col-md-4 control-label"><?=$CreateType; ?> Email</label>
                <div class="col-md-8">
                    {{ form.render("email", ["class": 'form-control', 'placeholder': 'Email', 'type': 'name','required':'']) }}
                </div>
            </div>
            <div class="form-group">
                <label for="phone" class="col-md-4 control-label"><?=$CreateType; ?> Phone</label>
                <div class="col-md-8">
                    {{ form.render("phone", ["class": 'form-control', 'placeholder': 'Phone', 'type': 'name']) }}
                </div>
            </div>
            <div class="form-group">
                <label for="address" class="col-md-4 control-label"><?=$CreateType; ?> Address</label>
                <div class="col-md-8">
                    {{ form.render("address", ["class": 'form-control', 'placeholder': 'Address', 'type': 'name']) }}
                </div>
            </div>
            <div class="form-group">
                <label for="locality" class="col-md-4 control-label"><?=$CreateType; ?> City</label>
                <div class="col-md-8">
                    {{ form.render("locality", ["class": 'form-control', 'placeholder': 'City', 'type': 'name']) }}
                </div>
            </div>
            <div class="form-group">
                <label for="state_province" class="col-md-4 control-label"><?=$CreateType; ?> State/Province</label>
                <div class="col-md-8">
                    {{ form.render("state_province", ["class": 'form-control', 'placeholder': 'State/Province', 'type': 'name']) }}
                </div>
            </div>
            <div class="form-group">
                <label for="postal_code" class="col-md-4 control-label"><?=$CreateType; ?> Postal Code</label>
                <div class="col-md-8">
            ...
            <div class="free_subscription_pricing_plan show">
                ...
                <div class="form-group">
                    <label for="locations" class="col-md-4 control-label"><?=$CreateType; ?> Locations</label>
                    <div class="col-md-8">
                ...
                <div class="form-group">
                    <label for="sms_messages" class="col-md-4 control-label"><?=$CreateType; ?> SMS Messages</label>
                    <div class="col-md-8">
            ...
            <div class="form-group">
                <label for="admin_name" class="col-md-4 control-label"><?=$CreateType; ?> Admin Full Name</label>
                <div class="col-md-8">
            ...
            <div class="form-group">
                <label for="admin_email" class="col-md-4 control-label"><?=$CreateType; ?> Admin Email</label>
                <div class="col-md-8">
