            ...
            <div class="row">
              <div class="col-md-3">
                <div class="easy-pie-chart">
                  <div class="number lastmonth" data-percent="{% if sms_sent_total > 0 %}<?php echo number_format((float)($click_through_total / $sms_sent_total) * 100, 0, '.', ''); ?>{% else %}0{% endif %}">
                    <span>{% if sms_sent_total > 0 %}<?php echo number_format((float) ($click_through_total / $sms_sent_total) * 100, 0, '.', ''); ?>{% else %}0{% endif %}</span>%
                  </div>
              ...
              <div class="col-md-3">
                <div class="easy-pie-chart">
                  <div class="number lastmonth" data-percent="{% if sms_sent_last_month > 0 %}<?php echo number_format((float) ($click_through_last_month / $sms_sent_last_month) * 100, 0, '.', ''); ?>{% else %}0{% endif %}">
                    <span>{% if sms_sent_last_month > 0 %}<?php echo number_format((float) ($click_through_last_month / $sms_sent_last_month) * 100, 0, '.', ''); ?>{% else %}0{% endif %}</span>%
                  </div>
              ...
              <div class="col-md-3">
                <div class="easy-pie-chart">
                  <div class="number thismonth" data-percent="{% if sms_sent_this_month > 0 %}<?php echo number_format((float) ($click_through_this_month / $sms_sent_this_month) * 100, 0, '.', ''); ?>{% else %}0{% endif %}">
                    <span>{% if sms_sent_this_month > 0 %}<?php echo number_format((float) ($click_through_this_month / $sms_sent_this_month) * 100, 0, '.', ''); ?>{% else %}0{% endif %}</span>%
                  </div>
        ...
        <div class="portlet light bordered" id="pnlConversionRate">
          ...
          <div class="portlet-body">
            <div class="row">
              <div class="col-md-3">
                <div class="easy-pie-chart">
                  <div class="number lastmonth" data-percent="{% if sms_sent_total > 0 %}<?php echo number_format((float) ($conversion_total / $sms_sent_total) * 100, 0, '.', ''); ?>{% else %}0{% endif %}">
                    <span>{% if sms_sent_total > 0 %}<?php echo number_format((float) ($conversion_total / $sms_sent_total) * 100, 0, '.', ''); ?>{% else %}0{% endif %}</span>%
                  </div>
                  <div class="pie-title"> Total </div>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="easy-pie-chart">
                  <div class="number lastmonth" data-percent="<?=($sms_sent_last_month > 0 ? number_format((float)($conversion_last_month / $sms_sent_last_month) * 100, 0, '.', '') : 0 )?>">
                    <span>{% if sms_sent_last_month > 0 %}<?php echo number_format((float) ($conversion_last_month / $sms_sent_last_month) * 100, 0, '.', ''); ?>{% else %}0{% endif %}</span>%
                  </div>
                  <div class="pie-title"> Last Month </div>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="easy-pie-chart">
                  <div class="number thismonth" data-percent="{% if sms_sent_this_month > 0 %}<?php echo number_format((float)($conversion_this_month / $sms_sent_this_month) * 100, 0, '.', ''); ?>{% else %}0{% endif %}">
                    <span>{% if sms_sent_this_month > 0 %}<?php echo number_format((float) ($conversion_this_month / $sms_sent_this_month) * 100, 0, '.', ''); ?>{% else %}0{% endif %}</span>%
                  </div>
                  <div class="pie-title"> This Month </div>
                </div>
              </div>
