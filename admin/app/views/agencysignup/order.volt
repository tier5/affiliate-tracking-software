                ...
                <div class="col-xs-12">
                    <div class="portlet light bordered dashboard-panel">
                        <div class="row contact-row">
                            ...
                            <div class="col-xs-9"><input type="text" class="form-control" placeholder="Please enter your first name" name="FirstName" value="{{ FirstName }}" required /></div>
                        </div>
                        <div class="row contact-row">
                            <div class="col-xs-3"><label>Last Name</label><span class="required">*</span></div>
                            <div class="col-xs-9"><input type="text" class="form-control" placeholder="Please enter your last name" name="LastName" value="{{ LastName }}" required /></div>
                        </div>
                        <div class="row contact-row">
                            <div class="col-xs-3"><label>Email</label><span class="required">*</span></div>
                            <div class="col-xs-9"><input type="email" class="form-control" placeholder="Please enter your email" name="OwnerEmail" value="{{ OwnerEmail }}" required /></div>
                        </div>
                        <div class="row contact-row">
                            <div class="col-xs-3"><label>Phone</label><span class="required">*</span></div>
                            <div class="col-xs-9"><input type="text" class="form-control" placeholder="Please enter your phone" name="OwnerPhone" value="{{ Phone }}" required /></div>
                        </div>
                        <div class="row contact-row">
                            <div class="col-xs-3"><label>Get A Company URL</label><span class="required">*</span></div>
                            <div class="col-xs-9"><input type="text" id="URL" class="form-control website-url" name="URL" value="{{ URL }}" required /></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-9">
                    <div class="">
                        <div class="row contact-row">
                            ...
                            <div class="col-xs-9"><input type="text" class="form-control" name="CardNumber" required /></div>
                        </div>
                        <div class="row contact-row">
