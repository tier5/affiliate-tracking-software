...
<div class="medium-section">
    ...
    <div class="row large-vertical-margins">
        <div class="col-xs-2"></div>
        <div class="col-xs-4 light-section benefits_c m_left">
        ...
        <div class="col-xs-4 light-section benefits_c m_right">
...
<div class="light-section">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 medium-vertical-margins">
        ...
        <div class="col-xs-12 col-sm-4 phone_sec">
    ...
    <div class="row medium-vertical-margins" style="margin-bottom: 0px;">
        ...
        <div class="col-xs-12 col-sm-6 medium-vertical-margins bigright">
            <div class="col-xs-12 col-sm-1">
        ...
        <div class="col-xs-12 col-sm-4 phone_sec bigleft">
    ...
    <div class="row medium-vertical-margins" style="margin-bottom: 0px;">
        <div class="col-sm-1 col-xs-12 col-centered">
    ...
    <div class="row">
        ...
        <div class="col-sm-5 col-xs-12">
            <div class="col-xs-12 col-sm-11">
                ...
                <div class="col-xs-12 col-sm-11 phone_sec_1">
...
<div class="medium-section top-padding owner_manager">
    <div class="row">
        <div class="col-xs-2"></div>
...
<div class="light-section top-padding bottom-padding serve_sec">
    <div class="row">
    ...
    <div class="row" style="margin-top: 50px;">
        <div class="col-xs-2"></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/auto.png" alt="Auto"><p>Auto Repair / Towing / New &amp; Used Car Dealers / Auto Body </p></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/restaurants.png" alt="Restaurants"><p>Restaurants / Cafe / Bars / Coffee Shops</p></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/sales_and_marketing.png" alt=""><p>Sales Services / Marketing Companies / Consulting Services</p></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/professional.png" alt="Professional"><p>Professional Services / Attorneys / Schools / Accounting</p></div>
    </div>


    <div class="row" style="margin-top: 50px;">
        <div class="col-xs-1"></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/healthcare.png" alt="Healthcare"><p>Healthcare Services / Cosmetic Dentists / Chiropractors / Medical Devices</p></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/mortgage.png" alt="Mortgage"><p>Mortgage Companies / Mortgage Consultants / Debt Consolidation</p></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/real_estate.png" alt="Real Estate"><p>Real Estate Agents / Brokerage Firms &amp; Real Estate Teams</p></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/web.png" alt="Website Designers"><p>Website Designers / Software Developers / Photographers</p></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/seo.png" alt="SEO"><p>Search Engine Optimization / Reputation Management</p></div>
    </div>


    <div class="row" style="margin-top: 50px;">
        <div class="col-xs-2"></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/insurance.png" alt="Insurance"><p>Auto Insurance / Home Insurance / Life Insurance / Business Insurance Service / Health Insurance</p></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/apartment.png" alt="Apartment"><p>Apartments &amp; Housing Rental / Hotels &amp; Motels</p></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/roofing.png" alt="Roofing"><p>Roofing Contractor / Plumbers / General Contractors &amp; Builders</p></div>
        <div class="col-xs-2"><img class="center-block" src="/img/agencysignup/sales/heating.png" alt="Heating"><p>Heating and Air / Air Conditioning / Solar Energy Equipment</p></div>
    </div>
...
<div class="medium-section top-padding">
    ...
    <div class="row">
        ...
        <div class="col-xs-6 text-center extra-small-vertical-margins">
            <h3 class="description-text footertext">With our automated account creation wizard and powerful mobile review funnel you'll have fresh online reviews coming in from your most recent customers in no time.</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-3"></div>
