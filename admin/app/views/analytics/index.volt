...
<header class="jumbotron subhead analyticspage" id="reviews">
    <div class="hero-unit">
      ...
      if (isset($this->session->get('auth-identity')['agencytype']) &&
            ...
            if ($is_upgrade) {
            $percent = ($total_sms_month > 0 ? number_format((float)(($sms_sent_this_month_total+$sms_sent_this_month_total_non) / $total_sms_month) *
            100, 0, '.', ''):100);
      ...
      ?>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 border-right">
                                        <div class="report-num"><?=$total_reviews_this_month_analytics?></div>
                                        <div class="report-title">This Month</div>
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <div class="report-num"><?=$total_reviews_last_month_analytics?></div>
                                        <div class="report-title">Last Month</div>
                                    </div>
                                </div>
                                <div class="row border-top left-bottom">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="report-num"><?=(isset($review_count_all_time_analytics)?$review_count_all_time_analytics:0)?></div>
        ...
        <div class="row">
            ...
            $thism = ($sms_sent_this_month > 0?round(($sms_converted_this_month / $sms_sent_this_month) * 100):0);
                        $last = ($sms_sent_last_month > 0?round(($sms_converted_last_month / $sms_sent_last_month) *
                        100):0);
                        $all_time = ($sms_sent_all_time > 0?round(($sms_converted_all_time / $sms_sent_all_time) *
                        100):0);
                        ?>
                        <div class="row">
                            <div class="col-md-6 col-sm-6 border-right">
