...
<div class="">
  <div class="pnlAddLocation short col-md-4">
    ...
    <div class="buttons"><a class="btnLink" id="googleLink" href="https://maps.google.com/?cid=<?=$google->external_id?>" target="_blank"><img src="/admin/img/icon-eye.gif" /> View</a> <a class="btnLink" href="#" onclick="changeLocation();$('#locationform1').show();return false;"><img src="/admin/img/icon-pencil.gif" /> Change Location</a></div>    
  </div>
  ...
  <div class="pnlAddLocation short col-md-4">
    ...
    <div class="buttons facebookfound" <?=($facebook->external_id?'':' style="display: none;"')?>><a id="facebookLink" href="http://facebook.com/" target="_blank"><img src="/admin/img/icon-eye.gif" />  View</a> <a class="btnLink" href="#" onclick="$('.facebookfound').hide();$('.facebooknotfound').show();return false;"><img src="/admin/img/icon-pencil.gif" />  Update Location</a></div>    
    <div class="buttons facebooknotfound" <?=($facebook->external_id?' style="display: none;"':'')?>><a class="btnLink" href="#" onclick="findBusiness('<?=$facebook->external_id?>');return false;"><img src="/admin/img/icon-maglass.gif" />  Search For Business</a> <a class="btnLink" href="#" id="urllink" onclick="$('#urltype').val('facebook');"><img src="/admin/img/icon-link.gif" /> Enter URL</a></div>
  ...
  <div class="pnlAddLocation short col-md-4">
    ...
    <div class="buttons yelpfound" <?=($yelp->external_id?'':' style="display: none;"')?>><a id="yelpLink" href="http://yelp.com/biz/" target="_blank"><img src="/admin/img/icon-eye.gif" />  View</a> <a class="btnLink" href="#" onclick="$('.yelpfound').hide();$('.yelpnotfound').show();return false;"><img src="/admin/img/icon-pencil.gif" />  Update Location</a></div>    
    <div class="buttons yelpnotfound" <?=($yelp->external_id?' style="display: none;"':'')?>><a class="btnLink" href="#" onclick="findBusinessYelp();return false;"><img src="/admin/img/icon-maglass.gif" />  Search For Business</a> <a class="btnLink" href="#" id="urllinkyelp" onclick="$('#urltype').val('yelp');"><img src="/admin/img/icon-link.gif" /> Enter URL</a></div>    
...
//console.log('test');
      $.ajax({
        ...
        url: '/admin/session/googlesearchapi/',
        data: {
