    ...
    <body class=" login">
        ...
        strpos($_SERVER['REQUEST_URI'],'login')>0) { ?>
            ...
            <?php if(strpos($_SERVER['REQUEST_URI'], 'invite') === false) { ?>
                <!-- BEGIN LOGO -->
                <div class="logo">
                    <a href="/"><img style="max-width: 625px;" src="<?=(isset($this->view->logo_path) && $this->view->logo_path != '' ? $this->view->logo_path : '/public/assets/layouts/layout/img/logo.png') ?>" alt="" /></a>
                </div>
                <!-- END LOGO -->
            <?php } ?>
