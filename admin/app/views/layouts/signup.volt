...
<div class="headercontent">
  <!-- BEGIN LOGO -->
  <div class="logo">
      <a href="/admin/"><img src="<?=(false && isset($logo_setting) && $logo_setting != ''?$logo_setting:'/admin/img/logo-white.gif')?>" alt="" /></a>
  </div>
  <!-- END LOGO -->
  <div class="steps">
    <div class="step"><img src="/admin/img/step-<?=($current_step > 1?'on':'current')?>.gif" alt="Sign up form, Step 1 (Account)" /></div>
    <div class="divider"><img src="/admin/img/step-line-<?=($current_step > 1?'on':'off')?>.gif" /></div>
    <div class="step"><img src="/admin/img/step-<?=($current_step == 2?'current':($current_step > 2?'on':'off'))?>.gif" alt="Sign up form, Step 2 (Add Location)" /></div>
    <div class="divider"><img src="/admin/img/step-line-<?=($current_step > 2?'on':'off')?>.gif" /></div>
    <div class="step"><img src="/admin/img/step-<?=($current_step == 3?'current':($current_step > 3?'on':'off'))?>.gif" alt="Sign up form, Step 3 (Customize Survey)" /></div>
    <div class="divider"><img src="/admin/img/step-line-<?=($current_step > 3?'on':'off')?>.gif" /></div>
    <div class="step"><img src="/admin/img/step-<?=($current_step == 4?'current':($current_step > 4?'on':'off'))?>.gif" alt="Sign up form, Step 4 (Add Employee)" /></div>
    <div class="divider"><img src="/admin/img/step-line-<?=($current_step > 4?'on':'off')?>.gif" /></div>
    <div class="step"><img src="/admin/img/step-<?=($current_step == 5?'current':($current_step > 5?'on':'off'))?>.gif" alt="Sign up form, Step 5 (Share)" /></div>
  </div>
