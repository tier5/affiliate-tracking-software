...
<header>
    <div class="headercontent">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <a href="/"><img style="max-width: 300px; margin-top: 15px;"  src="<?=(isset($this->view->logo_path) && $this->view->logo_path != ''?'/img/agency_logos/'.$logo_path:'/img/logo-white.gif')?>" alt="" /></a>
        </div>
        <!-- END LOGO -->
        <div class="steps">
