    ...
    <form id="hiddenLocationForm" class="form-horizontal" role="form" method="post" autocomplete="off">
      ...
      <div class="register-form" id="hiddenForm" style="display: block;">
        <div class="pnlAddLocation short col-md-4">
          ...
          <div class="buttons"><a class="btnLink" id="googleLink" href="https://maps.google.com/?cid=<?=$google->external_id?>" target="_blank"><img src="/img/icon-eye.gif" /> View</a> <a class="btnLink" href="#" onclick="$('#relevant-result-list').hide();$('#hiddenForm').hide();$('#locationform1').show();return false;"><img src="/img/icon-pencil.png" /> Change Location</a><br /><br /><a href="{{ authUrl }}" class="btnSecondary" target="_blank" id="gmb_signin">Connect Google My Business account</a></div>
        </div>
        ...
        <div class="pnlAddLocation short col-md-4">
          ...
          <div class="buttons facebookfound" <?=(isset($facebook) && isset($facebook->external_id) && $facebook->external_id != ''?'':' style="display: none;"')?>><a id="facebookLink" href="http://facebook.com/<?=(isset($facebook) && isset($facebook->external_id) && $facebook->external_id != ''?$facebook->external_id:'')?>" target="_blank"><img src="/img/icon-eye.gif" />  View</a> <a class="btnLink" href="#" onclick="$('.facebookfound').hide();$('.facebooknotfound').show();return false;"><img src="/img/icon-pencil.png" />  Update Location</a> <?php if (isset($facebook) && isset($facebook->external_id) && $facebook->external_id != '') { ?><!--<a href="/location/getAccessToken" id="btnAuthenticateFacebook" class="btnLink">Authenticate Facebook</a>--><?php } ?></div>
