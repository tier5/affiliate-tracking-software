...
if (isset($invite)) {
  ...
  <div class="rounded-wrapper NPS">
    <div class="rounded">
      ...
      <div class="row text-center"><a href="/review/<?=(10 < $threshold?'nothanks':'recommend')?>?r=10&a=<?=htmlspecialchars($_GET["a"])?>" class="btn-lg btn-recommend">10 - Very Likely</a></div>
      <div class="row text-center"><a href="/review/<?=(9 < $threshold?'nothanks':'recommend')?>?r=9&a=<?=htmlspecialchars($_GET["a"])?>" class="btn-lg btn-recommend">9</a></div>
      <div class="row text-center"><a href="/review/<?=(8 < $threshold?'nothanks':'recommend')?>?r=8&a=<?=htmlspecialchars($_GET["a"])?>" class="btn-lg btn-recommend">8</a></div>
      <div class="row text-center"><a href="/review/<?=(7 < $threshold?'nothanks':'recommend')?>?r=7&a=<?=htmlspecialchars($_GET["a"])?>" class="btn-lg btn-recommend">7</a></div>
      <div class="row text-center"><a href="/review/<?=(6 < $threshold?'nothanks':'recommend')?>?r=6&a=<?=htmlspecialchars($_GET["a"])?>" class="btn-lg btn-recommend">6</a></div>
      <div class="row text-center"><a href="/review/<?=(5 < $threshold?'nothanks':'recommend')?>?r=5&a=<?=htmlspecialchars($_GET["a"])?>" class="btn-lg btn-recommend">5</a></div>
      <div class="row text-center"><a href="/review/<?=(4 < $threshold?'nothanks':'recommend')?>?r=4&a=<?=htmlspecialchars($_GET["a"])?>" class="btn-lg btn-recommend">4</a></div>
      <div class="row text-center"><a href="/review/<?=(3 < $threshold?'nothanks':'recommend')?>?r=3&a=<?=htmlspecialchars($_GET["a"])?>" class="btn-lg btn-recommend">3</a></div>
      <div class="row text-center"><a href="/review/<?=(2 < $threshold?'nothanks':'recommend')?>?r=2&a=<?=htmlspecialchars($_GET["a"])?>" class="btn-lg btn-recommend">2</a></div>
      <div class="row text-center"><a href="/review/<?=(1 < $threshold?'nothanks':'recommend')?>?r=1&a=<?=htmlspecialchars($_GET["a"])?>" class="btn-lg btn-recommend">1 - Least Likely</a></div>
    </div>
