    ...
    <div class="col-md-12 col-sm-12">
      <div class="portlet light bordered dashboard-panel">
        ...
        <ul class="nav nav-tabs" style="margin-bottom: 12px;">
          <li><a style="border-top: 8px solid #F6F6F6 !important; padding: 14px 69px 53px;" href="/admin/reviews/sms_broadcast"> NEW MESSAGES </a></li>
          <li class="active"><a style="border-top: 8px solid #283643 !important; padding: 14px 69px 53px;" href="/admin/reviews/sent_message"> SENT MESSAGE </a></li>
        </ul>
              ...
              if($invitelist):
                foreach($invitelist as $invite): 
                  ...
                  <tr>
                    ...
                    <td><a href="/admin/reviews/sent_message_view/<?=$invite->sms_broadcast_id?>" class="btnLink" style="display: block;">View</a></td>
                  </tr>
                  <?php  
                endforeach; 
              else: 
