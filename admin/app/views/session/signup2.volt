    ...
    <div class="col-md-12">
        ...
        <div class="pnlAddLocation short col-md-4">
            <div class="title">FACEBOOK:
                <span class="title-answer"><span class="facebooknotfound">Not </span>Found</span></div>
            <div class="field"><span class="name">Business Name:</span>
                <span id="facebookName" class="facebookfound"></span><input class="facebooknotfound" id="facebooksearchfield" type="name" value=""/>
            </div>
            <div class="field bottom"><span class="name">Location:</span>
                <span id="facebookLocation" class="facebookfound"></span><input id="facebooksearchfield2" type="name" value="" class="facebooknotfound"/>
            </div>
            <div class="buttons facebookfound">
                <a id="facebookLink" href="http://facebook.com/" target="_blank" class="btnSecondary"><img src="/img/icon-eye.gif"/>
                    View</a>
                <a class="btnLink btnSecondary" href="#" onclick="$('.facebookfound').hide();$('.facebooknotfound').show();return false;"><img src="/img/icon-pencil.png"/>
                    Update Location</a></div>
            <div class="buttons facebooknotfound">
                <a class="btnLink btnSecondary" href="#" onclick="findBusiness('<?=$facebook_access_token?>');return false;"><img src="/img/icon-maglass.gif"/>
                    Search For Business</a>
                <a class="btnLink btnSecondary" href="#" id="urllink" onclick="$('#urltype').val('facebook');"><img src="/img/icon-link.gif"/>
                    Enter URL</a></div>
        ...
        <div class="pnlAddLocation short col-md-4">
            ...
            <div class="field"><span class="name">Business Name:</span>
                <span id="yelpName" class="yelpfound"></span><input id="yelpsearchfield" class="yelpnotfound" type="name" value=""/>
            </div>
            <div class="field bottom"><span class="name">Location:</span>
                <span id="yelpLocation" class="yelpfound"></span><input id="yelpsearchfield2" type="name" value="" class="yelpnotfound"/>
            </div>
            <div class="buttons yelpfound">
                <a id="yelpLink" href="http://yelp.com/biz/" class="btnSecondary" target="_blank"><img src="/img/icon-eye.gif"/>
                    View</a>
                <a class="btnLink btnSecondary" href="#" onclick="$('.yelpfound').hide();$('.yelpnotfound').show();return false;"><img src="/img/icon-pencil.png"/>
                    Update Location</a></div>
            <div class="buttons yelpnotfound">
                <a class="btnLink btnSecondary" href="#" onclick="findBusinessYelp();return false;"><img src="/img/icon-maglass.gif"/>
                    Search For Business</a>
                <a class="btnLink btnSecondary" href="#" id="urllinkyelp" onclick="$('#urltype').val('yelp');"><img src="/img/icon-link.gif"/>
                    Enter URL</a></div>
...
<div id="page-wrapper" style="display: none;">
    ...
    <div class="col-md-12">
        ...
        <div class="field"><span class="name">Enter URL:</span> <input type="text" value="" name="url" id="url"/>
            <a class="btnLink btnSecondary" href="#" onclick="searchByURL();return false;">Save</a></div>
    </div>
