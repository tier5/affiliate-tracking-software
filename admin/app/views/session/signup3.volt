  ...
  <div class="col-md-6 col-sm-6" style="margin-top: 30px;">
    ...
    <div class="row"><!--
      ...
      <div class="form-group col-md-6">
        ...
        <div class="color-select"><input type="text" id="sms_button_color" name="sms_button_color" class="form-control" data-control="hue" value="<?=(isset($_POST['sms_button_color'])?$_POST["sms_button_color"]:(isset($location->sms_button_color)?$location->sms_button_color:'#454545'))?>" style="margin: 4px;"  /> </div>
      </div>
    </div>
    
    <div class="form-group">
      <label class="control-label">Text Message Preview:</label>
      <textarea class="form-control placeholder-no-fix" autocomplete="off" name="sms_text_message_default" id="sms_text_message_default"><?=(isset($_POST['sms_text_message_default'])?$_POST["sms_text_message_default"]:(isset($location->sms_text_message_default)?$location->sms_text_message_default:'{name}, thank you for visiting {business-name} we\'d appreciate your feedback please click the link below.  Thanks! {link}'))?></textarea> 
              ...
              <div class="review index">
                <div class="rounded-wrapper">
                  <div class="rounded">
                    ...
                    <div class="row text-center"><a href="#" class="btn-lg btn-recommend">Yes</a></div>
