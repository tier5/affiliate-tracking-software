              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div id="image_container">
                    <img src="/img/feedback_request.png" data-id="1" <?=(isset($_POST['review_invite_type_id']) && $_POST['review_invite_type_id'] == 1?' class="selected"':(isset($objAgency->review_invite_type_id) && $objAgency->review_invite_type_id == 1?' class="selected"':''))?> />
                    <img src="/img/stars.png" data-id="2" <?=(isset($_POST['review_invite_type_id']) && $_POST['review_invite_type_id'] == 2?' class="selected"':(isset($objAgency->review_invite_type_id) && $objAgency->review_invite_type_id == 2?' class="selected"':''))?> />
                    <img src="/img/nps.png" data-id="3" <?=(isset($_POST['review_invite_type_id']) && $_POST['review_invite_type_id'] == 3?' class="selected"':(isset($objAgency->review_invite_type_id) && $objAgency->review_invite_type_id == 3?' class="selected"':''))?> />
                  </div>
