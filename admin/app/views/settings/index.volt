            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-8">
                  ...
                  onclick ="FnfacebookClickHandler(<?=$review_site_list->external_id?>)" target="_blank"  data-id="<?=$review_site_list->review_site_id?>" data-invite="<?=$review_site_list->review_invite_id?>">
                          View
                        </a> <?php } else {?> 
