    ...
    <div class="hero-unit">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                ...
                <div class="portlet light bordered dashboard-panel pricing-plans">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="price-includes">Price Includes</span>  
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="note-editor panel panel-default">
                            ...
                            <div class="note-toolbar panel-heading">
                                ...
                                <div class="note-para btn-group">
                                    <button type="button" class="btn btn-default btn-sm active" title="" data-event="insertUnorderedList" tabindex="-1" data-name="ul" data-original-title="Unordered list (CTRL+SHIFT+NUM7)"><i class="fa fa-list-ul"></i></button><button type="button" class="btn btn-default btn-sm" title="" data-event="insertOrderedList" tabindex="-1" data-name="ol" data-original-title="Ordered list (CTRL+SHIFT+NUM8)"><i class="fa fa-list-ol"></i></button>
                                    <div class="btn-group" data-name="paragraph">
                                        <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown" title="" tabindex="-1" data-original-title="Paragraph"><i class="fa fa-align-left"></i> <span class="caret"></span></button>
