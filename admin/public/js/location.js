...
function selectLocation(googleid, url, name, street_number, route, locality, administrative_area_level_1, postal_code, country, formatted_phone_number, lat, lng) {
    ...
    var name = unencode(name);
    var street_number = unencode(street_number);
    var route = unencode(route);
    var locality = unencode(locality);
    var administrative_area_level_1 = unencode(administrative_area_level_1);
    var postal_code = unencode(postal_code);
    var country = unencode(country);
    var formatted_phone_number = unencode(formatted_phone_number);
    ...
    $("#state_province").val(administrative_area_level_1);
    $("#country").val(country);
    $("#postal_code").val(postal_code);
    //$("#yelp_id").value = yelp_id;
    //$("#facebook_page_id").value = facebook_page_id;
    $("#google_place_id").val(cid);
    $("#latitude").val(lat);
    $("#longitude").val(lng);
    $("#google_api_id").val(googleid);
    ...
    $("#facebooksearchfield").val(name);
    $("#facebooksearchfield2").val(postal_code);
