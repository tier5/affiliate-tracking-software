        ...
        public function getTokens($code, $refresh = false)
        {
            ...
            if (empty($this->_tokens)) {
                ...
                $this->_tokens = array(
                    ...
                    "token_type" => $this->_body->token_type,
                    "stripe_publishable_key" => $this->_body->stripe_publishable_key,
                    "scope" =>  $this->_body->scope,
                    "livemode" =>  $this->_body->livemode,
                    "stripe_user_id" => $this->_body->stripe_user_id,
                    "refresh_token" => $this->_body->refresh_token,
                    "access_token" => $this->_body->access_token
                );
            }
            return $this->_tokens;
        }
