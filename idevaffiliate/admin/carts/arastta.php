...
<td width="95%"><a href="http://www.idevlibrary.com/files/iDevAffiliate_Arastta.zip" class="btn btn-danger btn-sm">Download the <?PHP echo $cart_name; ?> Plugin</a></td>
</tr>
<tr>
<td width="5%" align="center">2.</td>
<td width="95%">Unzip the <strong>iDevAffiliate_Arastta.zip</strong> file to your local computer. You should now have the <strong>idevaffiliate.ocmod.xml</strong> for use below.</td>
</tr>
<tr>
<td width="5%" align="center">3.</td>
<td width="95%">Login to your <?PHP echo $cart_name; ?> admin center and go to <strong>Extensions</strong> > <strong>Extension Installer</strong>. Use the <strong>idevaffiliate.ocmod.xml</strong> file (downloaded above) to complete the install.</td>
</tr>
<tr>
<td width="5%" align="center"></td>
<td width="95%"><img src="http://www.idevlibrary.com/files/arastta_install.png" style="width:800px; height:259px; border:none;" /></td>
</tr>
<tr>
...
<td width="95%">Switched to <strong>Advanced Mode</strong>. See image below.</td>
</tr>
<tr>
...
<tr>
<td width="5%" align="center"></td>
<td width="95%"><img src="http://www.idevlibrary.com/files/arastta_settings.png" style="width:800px; height:219px; border:none;" /></td>
</tr>
</table>
</div>
</div>
