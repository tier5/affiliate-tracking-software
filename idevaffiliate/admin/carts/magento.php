...
<tbody>
<tr>
<td width="100%" colspan="2" style="background:#000000; color:#FFFFFF;">Magento 1x</td>
</tr>
<tr>
<td width="5%">1.</td>
<td width="95%"><a href="http://www.idevlibrary.com/files/Idevaffiliate_Idevaffiliate-0.1.0.tgz" class="btn btn-danger btn-sm">Download the <?PHP echo $cart_name; ?> Plugin</a></td>
</tr>
<tr>
<td width="5%">2.</td>
<td width="95%">Login to you Magento admin center and go to <strong>System</strong> > <strong>Magento Connect</strong> > <strong>Magento Connect Manager</strong>. Use the plugin (downloaded above) to complete a <strong>Direct package file upload</strong>.</td>
</tr>
<tr>
<td width="5%" align="center"></td>
<td width="95%"><img src="http://www.idevlibrary.com/files/magento_plugin.png" style="width:781px; height:193px; border:none;" /></td>
</tr>
<tr>
<td width="5%">3.</td>
<td width="95%">Now return to your admin center and go to <strong>System</strong> > <strong>Configuration</strong> and you will see a new entry in the <strong>General</strong> menu called <strong>iDevAffiliate</strong>. Click on <strong>iDevAffiliate</strong> in the menu.</td>
</tr>
<tr>
<td width="5%" align="center"></td>
...
<tr>
<td width="5%" align="center"></td>
<td width="95%"><img src="http://www.idevlibrary.com/files/magento_settings.png" style="width:808px; height:385px; border:none;" /></td>
</tr>
</tbody>
</table>
</div>
