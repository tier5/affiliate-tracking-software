...
<td width="95%"><a href="http://www.idevlibrary.com/files/iDevAffiliate_Magic_Members.zip" class="btn btn-danger btn-sm">Download the <?PHP echo $cart_name; ?> Plugin</a></td>
</tr>
<tr>
...
<td width="95%"><img src="http://www.idevlibrary.com/files/magic_members_plugin.png" style="width:690px; height:74px; border:none;" /></td>
</tr>
<tr>
<td width="5%" align="center">3.</td>
<td width="95%">In WordPress, go to <strong>Settings</strong> -> <strong>General</strong>.</td>
</tr>
<tr>
<td width="5%" align="center"></td>
<td width="95%">In the <strong>iDevAffiliate Settings for Magic Members</strong> section, you can enable tracking and enter the following URL location for your <strong>iDevAffiliate Installation URL</strong>.</td>
</tr>
<tr>
<td width="5%"></td>
...
<tr>
<td width="5%" align="center"></td>
<td width="95%"><img src="http://www.idevlibrary.com/files/magic_members_settings.png" style="width:636px; height:262px; border:none;" /></td>
</tr>
</table>
</div>
</div>
