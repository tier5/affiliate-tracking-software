...
<td width="95%"><a href="http://www.idevlibrary.com/files/opencart_idevaffiliate.zip" class="btn btn-danger btn-sm">Download the <?PHP echo $cart_name; ?> Plugin</a></td>
</tr>
<tr>
<td width="5%" align="center">2.</td>
<td width="95%">Unzip the <strong>opencart_idevaffiliate.zip</strong> file to your local computer. You should now have the <strong>idevaffiliate.ocmod.xml</strong> for use below.</td>
</tr>
<tr>
<td width="5%" align="center">3.</td>
<td width="95%">Login to OpenCart and go to <strong>Extensions</strong> > <strong>Extension Installer</strong>. Use the <strong>idevaffiliate.ocmod.xml</strong> file (downloaded above) to complete the install.</td>
</tr>
<tr>
<td width="5%" align="center"></td>
<td width="95%"><img src="http://www.idevlibrary.com/files/opencart_installer.png" style="width:800px; height:244px; border:none;" /></td>
</tr>
<tr>
...
<tr>
<td width="5%" align="center"></td>
<td width="95%"><img src="http://www.idevlibrary.com/files/opencart_settings.png" style="width:800px; height:343px; border:none;" /></td>
</tr>
</table>
</div>
</div>
