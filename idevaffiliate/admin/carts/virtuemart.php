...
<td width="95%"><a href="http://www.idevlibrary.com/files/idevaffiliate_virtuemart.zip" class="btn btn-danger btn-sm">Download the <?PHP echo $cart_name; ?> Plugin</a></td>
</tr>
<tr>
...
<td width="95%"><img src="http://www.idevlibrary.com/files/virtuemart_plugin.png" style="width:800px; height:179px; border:none;" /></td>
</tr>
<tr>
<td width="5%" align="center">3.</td>
<td width="95%">Now go to <strong>Extensions</strong> -> <strong>Plugins</strong> and <span style="font-color:#CC0000;">enable</span> the <strong>iDevAffiliate / VirtueMart Integration</strong> plugin.</td>
</tr>
<tr>
<td width="5%" align="center"></td>
<td width="95%">Next, <span style="font-color:#CC0000;">edit</span> the <strong>iDevAffiliate / VirtueMart Integration</strong> plugin and enter the following URL location for your <strong>iDevAffiliate Installation URL</strong>.</td>
</tr>
<tr>
<td width="5%"></td>
...
<tr>
<td width="5%" align="center"></td>
<td width="95%"><img src="http://www.idevlibrary.com/files/virtuemart_settings.png" style="width:800px; height:329px; border:none;" /></td>
</tr>
</table>
