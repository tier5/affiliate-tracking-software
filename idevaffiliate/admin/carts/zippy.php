...
<td width="95%"><a href="http://www.idevlibrary.com/files/iDevAffiliate_Zippy_Courses.zip" class="btn btn-danger btn-sm">Download the <?PHP echo $cart_name; ?> Plugin</a></td>
</tr>
<tr>
...
<td width="95%"><img src="http://www.idevlibrary.com/files/zippy_plugin.png" style="width:739px; height:77px; border:none;" /></td>
</tr>
<tr>
...
<tr>
<td width="5%" align="center"></td>
<td width="95%">In the <strong>iDevAffiliate Settings for Zippy Courses</strong> section, you can enable tracking and enter the following URL location for your <strong>iDevAffiliate Installation URL</strong>.</td>
</tr>
<tr>
<td width="5%"></td>
...
<tr>
<td width="5%" align="center"></td>
<td width="95%"><img src="http://www.idevlibrary.com/files/zippy_settings.png" style="width:626px; height:248px; border:none;" /></td>
</tr>
</table>
</div>
</div>
