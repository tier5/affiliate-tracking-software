...
<link rel="stylesheet" href="templates/style_invoice.css" type="text/css">
    ...
    <style type="text/css">
	.image_paid {
    background: url("images/paid.png") no-repeat scroll 0 0 rgba(0, 0, 0, 0);
    height: 85px;
    position: absolute;
    right: 100px;
    top: 2px;
		...
		<table class="table_invoice" border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tbody>
				<tr>
					...
					<td width="34%"><?PHP echo $affiliate_id; ?></td>
...
?>
	...
	<div class="image_paid"></div>
		<table class="table_invoice" border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<td width="75%"><?PHP echo $pdatedisplay; ?></td>
			</tr>
			<tr>
				<td width="25%"><?PHP if ($pexacttotaldebs <= 0) { ?><font color="#CC0000"><?PHP } ?>Payment Amount<?PHP if ($pexacttotaldebs <= 0) { ?></font><?PHP } ?></td>
				<td width="75%"><?PHP if ($pexacttotaldebs <= 0) { ?><font color="#CC0000"><?PHP } ?><?PHP if($cur_sym_location == 1) { echo $cur_sym; } echo number_format($pexacttotalorig,$decimal_symbols); if($cur_sym_location == 2) { echo " " . $cur_sym . " "; }echo " $currency"; ?><?PHP if ($pexacttotaldebs <= 0) { ?><?PHP } ?></td>
			</tr>
<?PHP if ($pexacttotaldebs > 0) { ?>
			<tr>
				<td width="25%">Minus Debit Amount</td>
				<td width="75%"><?PHP if($cur_sym_location == 1) { echo $cur_sym; } echo $pexacttotaldebsd; if($cur_sym_location == 2) { echo " " . $cur_sym . " "; }echo " $currency"; ?></td>
			</tr>
			<tr>
