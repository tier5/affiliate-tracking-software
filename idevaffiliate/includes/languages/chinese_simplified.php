...
$signup_login_minmax_chars = "用户名长度必须至少为user_min_chars个字符并且不超过user_max_chars个字符。&lt;BR /&gt;&lt;BR /&gt;密码长度必须至少为pass_min_chars个字符并且不超过pass_max_chars个字符。&lt;BR /&gt;&lt;BR /&gt;两者都只可以含有字母以及数字。";
...
$help_new_password_info = "您的密码长度必须至少为pass_min_chars个字符并且不超过pass_max_chars个字符。它只可以包含字母、数字及下划线。";
...
$error_title = "检测到以下错误";
$username_invalid = "无效的用户名。它只可以包含字母和数字。";
...
$password_invalid = "无效的密码。它只可以包含字母和数字。";
