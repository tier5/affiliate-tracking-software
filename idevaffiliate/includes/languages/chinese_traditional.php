...
$signup_login_minmax_chars = "用戶名必須至少user_min_chars個字符和不多於user_max_chars個字符。&lt;BR /&gt;&lt;BR /&gt;密碼必須至少user_min_chars個字符和不多於user_max_chars個字符。&lt;BR /&gt;&lt;BR /&gt;兩者可以只包含字母和數字。";
...
$help_new_password_info = "你的密碼必須至少pass_min_chars個字符和不多於pass_max_chars個字符，並可以只包含字母、數字和下劃線。";
