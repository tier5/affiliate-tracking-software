...
$signup_login_minmax_chars = "طول نام کاربری باید حداقل  user_min_chars  و حداکثر user_max_chars  کرکتر باشد. &lt;BR /&gt;&lt;BR /&gt; رمز عبور باید حداقل pass_min_chars و حداکثر pass_max_chars کرکتر طول داشته باشد.   هم نام کاربری و هم رمز عبور می‌توانند فقط شامل حروف و اعداد باشند.";
...
$help_new_password_info = "رمز عبور باید حداقل pass_min_chars و حداکثر pass_max_chars کرکتر طول داشته باشد. رمز عبور می‌تواند فقط شامل حروف و اعداد و خط زیر باشد.";
...
$username_invalid = "نام کاربری نامعتبر. نام کاربری فقط باید شامل حروف و اعداد باشد.";
...
$password_invalid = "رمز عبور نامعتبر است. رمز عبور باید فقط شامل حروف و اعداد باشد.";
