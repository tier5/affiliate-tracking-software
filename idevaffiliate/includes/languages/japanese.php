...
$signup_login_minmax_chars = "ユーザー名は最低user_min_chars文字以上で最大user_max_chars文字以下でなければなりません。&lt;BR /&gt;&lt;BR /&gt;パスワードは最低pass_min_chars文字以上で最大pass_max_chars characters文字以下でなければなりません。&lt;BR /&gt;&lt;BR /&gt;どちらも文字と数字のみしか使用できません。";
...
$help_new_password_info = "あなたのパスワードは最低pass_min_chars文字以上、最大pass_max_chars文字以下でなければなりません。文字と数字、アンダースコアのみ利用可能です。";
...
$username_invalid = "無効なユーザー名です。文字と数字のみ使用可能です。";
...
$password_invalid = "無効なパスワードです。文字と数字のみ使用可能です。";
