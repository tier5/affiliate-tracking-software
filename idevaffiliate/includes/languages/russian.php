...
$signup_login_minmax_chars = "Имена пользователей должны быть по крайней мере user_min_chars символов в длину и не более user_max_chars символов в длину. &lt;BR /&gt;&lt;BR /&gt; Пароли должны быть, по крайней мере pass_min_chars символов в длину и не более pass_max_chars символов в длину. &lt;BR /&gt;&lt;BR /&gt; Оба могут содержать только буквы и цифры. ";	
...
$help_new_password_info = "Ваш пароль должен быть не менее pass_min_chars символов в длину и не более pass_max_chars символов. Он  может содержать только буквы, цифры и подчеркивания.";	
...
$username_invalid = "Неправильное имя пользователя. Оно может содержать только буквы и цифры.";	
...
$password_invalid = "Неверный пароль. Он может содержать только буквы и цифры.";	
