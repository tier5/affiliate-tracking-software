...
$signup_login_minmax_chars = "ชื่อผู้ใช้ต้องมีความยาวอย่างต่ำ user_min_chars ตัวอักษร และไม่ยาวเกิน user_max_chars ตัวอักษร&lt;BR /&gt;&lt;BR /&gt;รหัสผ่านต้องมีความยาวอย่างต่ำ pass_min_chars ตัวอักษร และไม่ยาวเกิน pass_max_chars ตัวอักษร&lt;BR /&gt;&lt;BR /&gt;ทั้งคู่สามารถประกอบด้วยเพียงพยัญชนะหรือตัวเลขก็ได้";
...
$help_new_password_info = "รหัสผ่านต้องมีความยาวอย่างต่ำ pass_min_chars ตัวอักษร และไม่ยาวเกิน pass_max_chars ตัวอักษร  รหัสผ่านสามารถประกอบได้ด้วยพยัญชนะ ตัวเลข และอันเดอร์สกอร์";
...
$username_invalid = "ชื่อผู้ใช้ไม่ถูกต้อง มันสามารถประกอบด้วยพยัญชนะหรือตัวเลขเท่านั้น";
...
$password_invalid = "รหัสผ่านไม่ถูกต้อง มันสามารถประกอบด้วยพยัญชนะหรือตัวเลขเท่านั้น";
