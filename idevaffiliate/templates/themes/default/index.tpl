...
<label>{$index_login_username}</label>
<input class="form-control" placeholder="{$index_login_username}" type="text" name="userid" value="{$index_login_username_field}"/>
</div>
<div class="form-group">
<label>{$index_login_password}</label>
