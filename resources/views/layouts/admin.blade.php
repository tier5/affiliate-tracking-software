...
<head>
  ...
  <title>Review Velocity | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg">Review Velocity</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active">
          <a href="#">
            <i class="fa fa-user-secret"></i> <span>Agencies</span>
        ...
        <li>
          <a href="#">
            ...
            <span class="pull-right-container">
              <span class="label label-primary pull-right">40</span>
            </span>
          </a>
        </li>
        <li>
...
@show
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; {{ date('Y') }} Review Velocity.</strong> All rights
    reserved.
  </footer>
